...
def show_after_started():
    ...
    settings = [
        ...
        {"label": "Brake resistance [Ohm]", "path": "config.brake_resistance", "info": "Resistance of the brake resistor, this is used to dissipate the energy of the motor when decelerating. If you don't have a brake resistor, you can set this to 0."}
    ]
